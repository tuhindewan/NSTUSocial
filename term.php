...
<TITLE>  Terms of Service, NSTUSocial </TITLE>
...
<!--------CREATE_TIME--------------->
<!--I love PriorityDigital.com they gave me this free disclaimer-->
<!--------/CREATE_TIME--------------->
<!--------LAST_TIME--------------->
...
<center><H2> Thebrotherhood, LLC  Web Site Agreement </H2></center>
<blockquote>
The The Brotherhood Web Site (the "Site") is an online information
service provided by Thebrotherhood, LLC   ("The Brotherhood "),
...
MAY NOT ACCESS OR USE THE SITE. The Brotherhood MAY MODIFY THIS
...
trademarks are The Brotherhood, its affiliates or other third party
...
The Brotherhood a non-exclusive, royalty-free, worldwide, perpetual
...
boards, forums and newsgroups) or by e-mail to The Brotherhood by all
means and in any media now known or hereafter developed. You also
grant to The Brotherhood the right to use your name in connection with
...
The Brotherhood for any alleged or actual infringement or
misappropriation of any proprietary right in your communications to
The Brotherhood.
</blockquote><p>

<!--Thank You!-->                                                                                        <img src="http://www.easyriver.com/irs/example_traffic_module.php3?level=090304_The Brotherhood" alt="TrafficServer 1.01 " width="1" height="1">
...
The Brotherhood. Other product and company names
...
clearly identified as being supplied by The Brotherhood,
The Brotherhooddoes not operate, control or endorse any information, products or
...
The Brotherhood  a. You also understand that
The Brotherhood cannot and
...
SITE AND THE INTERNET. The Brotherhood PROVIDES THE SITE AND
...
GENERALLY, AND The Brotherhood SHALL NOT BE LIABLE FOR ANY COST
...
The Brotherhood DOES NOT WARRANT THAT THE SERVICE WILL BE
...
The Brotherhood HAS NO CONTROL OVER AND ACCEPTS NO
RESPONSIBILITY WHATSOEVER FOR SUCH MATERIALS.
<p>

<center>LIMITATION OF LIABILITY</center><br>
IN NO EVENT WILL The Brotherhood BE LIABLE FOR (I) ANY INCIDENTAL,
...
INFORMATION OR SERVICE.  EVEN IF The Brotherhood OR ITS
...
STATES, The Brotherhood LIABILITY IS LIMITED TO THE GREATEST
EXTENT PERMITTED BY LAW.
<p>

The Brotherhood makes no representations whatsoever about any other
web site which you may access through this one or which may link to
this Site. When you access a non-The Brotherhood web site, please
understand that it is independent from The Brotherhood, and that
The Brotherhood has no control over the content on that web site. In
addition, a link to a The Brotherhood web site does not mean that
The Brotherhood endorses or accepts any responsibility for the content,
...
<blockquote>
You agree to indemnify, defend and hold harmless The Brotherhood, its
...
(Indemnification) are for the benefit of The Brotherhood and its
officers, directors, employees, agents, licensors, suppliers, and any
...
action or proceeding between The Brotherhood and you for any purpose
...
cause of action is barred. The Brotherhood's failure to insist upon or
...
modify any provision of this Agreement.  The Brotherhood may assign
...
<!-- Thank you! -->
COPYRIGHT NOTICE.&copy 1999-2012 <a href='http://209.204.219.152'>PriorityDigital.com</a>
Prepared for: The Brotherhood ,All rights reserved.
<BR><BR>
Get your own free disclaimer on-line <A href="http://209.204.219.152/free_disclaimer.htm">here</a>.
